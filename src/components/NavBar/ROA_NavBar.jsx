...
function ROA_NavBar({ style }) {
    ...
    <div style={{ justifyContent: "space-between", width: "330px",
        ...
        <img src="/ROA.svg" alt="" style={{ height: "80px" }} onClick={() => navigate(`/`)}/>
        <div>
            <RoundButton  icon={faHouse} color="black" onClick={() => navigate(`/`)} bgColor="#A0D8F6"/>
